...
* forward received data to Message Streaming Platform [ADR-015](/ADR/ADR-015-event-broker-kafka.md)
...
In case of detected anomaly, this component pushes new message to alert topic on Message Streaming Platform with all details necessary to produce alarm.

The Message Streaming Platform has been chosen here in order to implement at least 2 ways of delivering alerts:
